...
TRANSLATIONS["ru"].update({
    "export_word": "📘  Word", "export_pdf": "📕  PDF", "export_excel": "📗  Excel",
    "generating_word": "Генерация Word...", "generating_excel": "Генерация Excel...",
    "word_error": "Ошибка Word", "excel_error": "Ошибка Excel"})
TRANSLATIONS["en"].update({
    "export_word": "📘  Word", "export_pdf": "📕  PDF", "export_excel": "📗  Excel",
    "generating_word": "Generating Word...", "generating_excel": "Generating Excel...",
    "word_error": "Word error", "excel_error": "Excel error"})
TRANSLATIONS["kz"].update({
    "export_word": "📘  Word", "export_pdf": "📕  PDF", "export_excel": "📗  Excel",
    "generating_word": "Word жасалуда...", "generating_excel": "Excel жасалуда...",
    "word_error": "Word қатесі", "excel_error": "Excel қатесі"})

TRANSLATIONS["ru"].update({
    "set_threshold": "Порог аномалии", "set_rows": "Строк по умолчанию",
    "set_interval": "Интервал обновления (сек)", "set_notif_section": "Уведомления",
    "set_notif_enable": "Включить уведомления", "set_notif_level": "Мин. уровень уведомления",
    "set_api_port": "Порт API", "set_interface": "Интерфейс", "set_language": "Язык",
    "set_theme": "Тема оформления", "theme_dark": "Тёмная", "theme_light": "Светлая",
    "set_startup_section": "Запуск", "set_autoscan": "Авто-скан системы при старте"})
TRANSLATIONS["en"].update({
    "set_threshold": "Anomaly threshold", "set_rows": "Default rows",
    "set_interval": "Refresh interval (sec)", "set_notif_section": "Notifications",
    "set_notif_enable": "Enable notifications", "set_notif_level": "Min notification level",
    "set_api_port": "API port", "set_interface": "Interface", "set_language": "Language",
    "set_theme": "Theme", "theme_dark": "Dark", "theme_light": "Light",
    "set_startup_section": "Startup", "set_autoscan": "Auto-scan system on startup"})
TRANSLATIONS["kz"].update({
    "set_threshold": "Аномалия шегі", "set_rows": "Әдепкі жолдар",
    "set_interval": "Жаңарту аралығы (сек)", "set_notif_section": "Хабарламалар",
    "set_notif_enable": "Хабарламаларды қосу", "set_notif_level": "Мин. хабарлама деңгейі",
    "set_api_port": "API порты", "set_interface": "Интерфейс", "set_language": "Тіл",
    "set_theme": "Безендіру тақырыбы", "theme_dark": "Қараңғы", "theme_light": "Ашық",
    "set_startup_section": "Іске қосу", "set_autoscan": "Іске қосқанда жүйені авто-сканерлеу"})

TRANSLATIONS["ru"].update({"an_cpu":"Загрузка CPU","an_ram":"Память","an_procs":"Процессов",
    "an_threats":"Угроз сейчас","an_last_scan":"ПОСЛЕДНЕЕ СКАНИРОВАНИЕ"})
TRANSLATIONS["en"].update({"an_cpu":"CPU load","an_ram":"Memory","an_procs":"Processes",
    "an_threats":"Threats now","an_last_scan":"LAST SCAN"})
TRANSLATIONS["kz"].update({"an_cpu":"CPU жүктемесі","an_ram":"Жад","an_procs":"Процестер",
    "an_threats":"Қазір қауіп","an_last_scan":"СОҢҒЫ СКАНЕРЛЕУ"})
